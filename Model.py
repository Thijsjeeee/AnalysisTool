...
class DT_System:
    ...
    def M(self): #M = (Gn^-1 G - I) --> (1,11) , (1,11)
        ...
        Num = [c[0]*b[0]                         - d[0]*a[0],
               ...
               c[0]*b[2] + c[1]*b[1] + c[2]*b[0] - d[0]*a[2] - d[1]*a[1] - d[2]*a[0] + 16,
    ...
    def Q(self):
        ti = 1 / (self.Bi_DO * self.tz)
        a0 = 4/self.Ts**2 *(1/ti)**2 + 2/self.Ts * np.sqrt(2) * 1/ti + 1
        a1 = -2*4/self.Ts**2 *(1/ti)**2 + 2
        a2 = 4/self.Ts**2 *(1/ti)**2 - 2/self.Ts * np.sqrt(2) * 1/ti + 1
    ...
    def IQM(self): #(I + QM)^-1 --> (1,19) , (1,19)
        ...
        Num = [c[0]*a[0]                         + d[0]*b[0],
               ...
               c[0]*a[3] + c[1]*a[2] + c[2]*a[1] + d[0]*b[3] + d[1]*b[2] + d[2]*b[1],
               c[0]*a[4] + c[1]*a[3] + c[2]*a[2] + d[0]*b[4] + d[1]*b[3] + d[2]*b[2],
               c[0]*a[5] + c[1]*a[4] + c[2]*a[3] + d[0]*b[5] + d[1]*b[4] + d[2]*b[3],
               c[0]*a[6] + c[1]*a[5] + c[2]*a[4] + d[0]*b[6] + d[1]*b[5] + d[2]*b[4],
               c[0]*a[7] + c[1]*a[6] + c[2]*a[5] + d[0]*b[7] + d[1]*b[6] + d[2]*b[5],
               c[0]*a[8] + c[1]*a[7] + c[2]*a[6] + d[0]*b[8] + d[1]*b[7] + d[2]*b[6],
               c[0]*a[9] + c[1]*a[8] + c[2]*a[7] + d[0]*b[9] + d[1]*b[8] + d[2]*b[7],
               c[0]*a[10]+ c[1]*a[9] + c[2]*a[8] + d[0]*b[10]+ d[1]*b[9] + d[2]*b[8],
                         + c[1]*a[10]+ c[2]*a[9]             + d[1]*b[10]+ d[2]*b[9],
                                     + c[2]*a[10]                        + d[2]*b[10]]
        Den = [c[0]*a[0],
               c[0]*a[1] + c[1]*a[0],
               c[0]*a[2] + c[1]*a[1] + c[2]*a[0],
               ...
               c[0]*a[5] + c[1]*a[4] + c[2]*a[3],
               c[0]*a[6] + c[1]*a[5] + c[2]*a[4],
               c[0]*a[7] + c[1]*a[6] + c[2]*a[5],
               c[0]*a[8] + c[1]*a[7] + c[2]*a[6],
               c[0]*a[9] + c[1]*a[8] + c[2]*a[7],
               c[0]*a[10]+ c[1]*a[9] + c[2]*a[8],
                         + c[1]*a[10]+ c[2]*a[9],
                                     + c[2]*a[10]]
        return Den, Num
    ...
    def f_DO(self, x):
        return {
            False: [np.append(np.zeros((1,10)),self.HG()[0]) , np.append(np.zeros((1,10)),self.HG()[1])],
            True: self.H(),
        }[x]
